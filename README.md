...
1. Create a [python virtual environment](https://docs.python.org/3/library/venv.html) and activate this environment. Make sure this virtual environment has Python 3.7-3.9 and setuptools >= 65.4. 
2. Install human_me:
```console
