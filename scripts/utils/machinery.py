...
# # DON'T DELETE------------------------------------------------
# import pandas as pd
# e3_ligase = pd.read_csv(build_files_path + 'machinery/E3_HPA.tsv', sep = '\t')
...
# e2_ligase = pd.read_csv(build_files_path + 'machinery/E2_HPA.tsv', sep = '\t')
