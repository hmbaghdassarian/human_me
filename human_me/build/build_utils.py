...
def get_all_expression_reactions(hgnc_id: str, reactions: List[cobra.Reaction], ub_args: Dict[str, Any], psim: pd.DataFrame = params.psim_me,
    ...
    psim : pd.DataFrame, optional
        see PSIM_README, by default params.psim_me
    machinery_list : List[str], optional
        each entry is the HGNC ID of a protein that should be considered as catalyzing a reaction, by default mach.metabolic_machinery, by default mach.metabolic_machinery
