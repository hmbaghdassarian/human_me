...
def eval_complex(expr: str) -> List[Union[str, List[str]]]:
    ...
    Returns
    -------
    complexes : List[str, List[str]]
        list of complexes according to GPR, separate lists are due to OR
    """
