...
def cleave_ub(hgnc_id: str, ub_args: Dict[str, Any], compress_mrna: bool, stochastic: bool, seeds: List[int]):
    ...
    processed_unfolded_protein_c = Protein(id_='processed_unfolded', compartment='c',
                                           gene_info=gene_info)  # Protein(id_ = hgnc_id + '_processed_unfolded',compartment = 'c', amino_acid_counts = gene_info.amino_acid_counts)
...
def build_ribosome_protein_expression_reactions(ub_args: Dict[str, Any], compress_mrna: bool, stochastic: bool, seeds: List[int]):
    ...
    for i in rs_ids:
        ...
        mrna_expression_reactions, mrna_transcript_c, mrna_deg_proxy = build_mrna.get_mrna_expression_reactions(
            gene_info, compress_mrna=compress_mrna)
...
def build_other_rrna_reactions(rrna5s_complex_n, rs_protein_metabolites, rl_protein_metabolites,
    ...
    ets_5_frag3_n = RNA_fragment('5_frag3', seq=ets_5_frag3_seq, compartment='n', triphosphate=False,
                                 fragment_type='ets')
    ...
    its_1_frag1_n = RNA_fragment('1_frag1', seq=its_1_frag1_seq, fragment_type='its', compartment='n',
                                 triphosphate=False)
...
def build_ribosome(ub_args: Dict[str, Any], compress_mrna: bool, reversible_complex_formation: bool, stochastic: bool, seed: int):
    ...
    with func.HiddenPrints():
        ...
        rs_expression_reactions, rs_protein_metabolites, rl_expression_reactions, rl_protein_metabolites = build_ribosome_protein_expression_reactions(
            ub_args=ub_args, compress_mrna=compress_mrna,
