...
seq_amino_acid_map_m = {aa_code: human_model.metabolites.get_by_id('_'.join(aa_metabolite.id.split('_')[:-1]) + '_m')
                        for aa_code, aa_metabolite in seq_amino_acid_map_c.items()}
seq_amino_acid_map_l = {aa_code: human_model.metabolites.get_by_id('_'.join(aa_metabolite.id.split('_')[:-1]) + '_l')
                        for aa_code, aa_metabolite in seq_amino_acid_map_c.items()}
seq_amino_acid_map_x = {aa_code: human_model.metabolites.get_by_id('_'.join(aa_metabolite.id.split('_')[:-1]) + '_x')
                        for aa_code, aa_metabolite in seq_amino_acid_map_c.items()}
seq_amino_acid_map_n = {aa_code: human_model.metabolites.get_by_id('_'.join(aa_metabolite.id.split('_')[:-1]) + '_n')
                        for aa_code, aa_metabolite in seq_amino_acid_map_c.items()}
seq_amino_acid_map_r = {aa_code: human_model.metabolites.get_by_id('_'.join(aa_metabolite.id.split('_')[:-1]) + '_r')
                        for aa_code, aa_metabolite in seq_amino_acid_map_c.items()}
