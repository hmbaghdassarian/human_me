...
class MetaboliteBin:
    ...
    def __init__(self, me_input_model):
        ...
        biomass_coefficients : Dict
            passed from build.build_me_model build_me function
        """
        ...
        # # in case input model has different biomass metabolites than recon2
        # for metab_dict in biomass_coefficients.values():
        #     if metab_dict is not None:
        #         for metab_id in metab_dict:
        #             if metab_id not in self.__dict__:
        #                 self.__dict__[metab_id] = self.id_object_map[metab_id]
